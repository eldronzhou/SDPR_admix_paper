...
../../../SDPR_admix/SDPR_admix -vcf ../../../genotype/Topmed/${i}.filter.vcf -rho 0.98 -msp ../../../genotype/Topmed/Rfmix/chr_${i}.msp.tsv -covar ../../../phenotype/SDPR/covar.txt -pheno ../../../phenotype/SDPR/BMI.txt -out ./res_${i}.txt
