...
../../../SDPR_admix2/SDPR_admix -rho 0.999 -vcf ../../../genotype/Topmed/${i}.filter.vcf -msp ../../../genotype/Topmed/Rfmix/chr_${i}.msp.tsv -covar ../../../phenotype/SDPR/covar.txt -pheno ../../../phenotype/SDPR/BMI.txt -out ./res_${i}.txt
