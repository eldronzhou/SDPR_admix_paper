...
../../../SDPR_admix2/SDPR_admix -rho 0  -vcf ../../../genotype/Topmed/${i}.filter.vcf -msp ../../../genotype/Topmed/Rfmix/chr_${i}.msp.tsv -covar ../../../phenotype/SDPR/covar2.txt -pheno ../../../phenotype/SDPR/WBC.txt -out ./res_${i}.txt
